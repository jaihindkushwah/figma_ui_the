...
function HeroSection() {
  return (
    <div className="mt-0 mx-8 flex   items-center flex-col">
      ...
      <div className="flex gap-32 items-center pl-10 pr-5 ">
        <div className="pl-10 flex justify-center items-center relative">
        ...
        <div className="flex h-full flex-col justify-between mt-28  p-10 pb-0">
